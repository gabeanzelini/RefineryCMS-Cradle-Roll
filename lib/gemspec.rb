#!/usr/bin/env ruby
require File.expand_path('../births.rb', __FILE__)
version = ::Refinery::Births.version
...
Gem::Specification.new do |s|
  ...
  s.summary           = %qA way to post new births to RefineryCMS-driven website.}
...
File.open(File.expand_path("../../refinerycms-cradle-roll.gemspec", __FILE__), 'w').puts(gemspec)
